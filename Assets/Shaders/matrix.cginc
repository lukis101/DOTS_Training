...
{
    float4x4 m = float4x4(float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 1));
...
float4x4 euler_to_matrix(float heading, float attitude, float bank)
{
    float4x4 m = float4x4(float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 1));
...
float4x4 euler_to_matrix_nobank(float heading, float attitude)
{
    float4x4 m = float4x4(float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 0), float4(0, 0, 0, 1));
...
void extract_scale(in float4x4 m, out float3 scale)
{
    float sx = length(float3(m[0][0], m[1][0], m[2][0]));
    float sy = length(float3(m[0][1], m[1][1], m[2][1]));
    float sz = length(float3(m[0][2], m[1][2], m[2][2]));
